  ...
  return (
    <header className="fixed top-0 w-full bg-background/95 backdrop-blur-md border-b border-border z-50">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between relative">
        ...
        >
          <img src={logo} alt="Twenty Two" className="h-8 sm:h-9 md:h-10" />
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            {isSearchOpen && (
              <form
                ...
                className="absolute right-0 mt-2 w-60 bg-background/95 border border-border p-2 rounded shadow-md"
              >
                <input
                  value={query}
          ...
          <button
            ...
            className="relative hover:text-primary transition-colors p-2 md:p-3"
          >
      ...
      {/* MENU SIDEBAR */}
      <aside
        className={`fixed top-0 left-0 h-screen w-screen sm:w-[420px] bg-background shadow-2xl z-[999] border-r border-border flex flex-col transition-transform duration-300 ${
